...
**AI/ML Engineer | Data Scientist | PhD Candidate in Physics**
...
- **Generative models** (conditional WGANs, VAEs) for synthetic data generation
- **Sensor fusion and visual odometry** for autonomous rover navigation
- **LLM applications**: RAG pipelines, fine-tuning (QLoRA), multi-agent systems
